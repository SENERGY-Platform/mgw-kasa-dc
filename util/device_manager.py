...
from util import MQTTClient, KasaDevice, get_logger, conf
...
class DeviceManager(threading.Thread):
    ...
    def handle_new_device(self, device: KasaDevice):
        try:
    ...
    def handle_missing_device(self, device: KasaDevice):
    ...
    def handle_existing_device(self, device: KasaDevice):
        try:
    ...
    def get_devices(self) -> Dict[str, KasaDevice]:
        return self._devices

    def set_devices(self, devices: Dict[str, KasaDevice]):
